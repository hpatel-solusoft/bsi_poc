...
class AppWorksPaths:
    ...
    class Allegations:
        ...
        @staticmethod
        def allegations_by_type(type_id: str) -> str:   # Updated parameters needs to passed to fetch allegations by type with status and top  
        ...
        @staticmethod
        def allegations_by_type_status(type_id: str, top: int, status: str) -> str:   # Updated parameters needs to passed to fetch allegations by type with status and top  
            # return f"/entities/Allegations/lists/Allegations_All?Allegations_AllegationsType$Identity.Id={type_id}"
